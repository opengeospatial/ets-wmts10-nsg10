...
public class GetCapabilitiesCrsTest extends AbstractBaseGetCapabilitiesFixture {
    /**
     * --- NSG Requirement 11: An NSG WMTS server shall support the following coordinate reference systems: • CRS:84
     * WGS84 geographic longitude, then latitude, expressed in decimal degrees • EPSG:4326 WGS84 geographic latitude,
     * then longitude, expressed in decimal degrees ---
     */
