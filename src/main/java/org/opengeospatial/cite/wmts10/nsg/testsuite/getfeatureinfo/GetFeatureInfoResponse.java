...
public class GetFeatureInfoResponse extends AbstractBaseGetFeatureInfoFixture {
	...
	/**
	 * --- NSG Requirement 20: An NSG WMTS server shall provide the GetFeatureInfo output
	 * format in text/XML and text/HTML. ---
	 */
	@Test(description = "NSG Web Map Tile Service (WMTS) 1.0.0, Requirement 20",
	...
	private boolean checkFormat(Document wmtsCapabilities, String xPathAbstract) throws XPathExpressionException {
