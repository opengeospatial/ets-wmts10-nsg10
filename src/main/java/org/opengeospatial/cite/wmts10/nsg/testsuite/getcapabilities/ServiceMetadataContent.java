...
public class ServiceMetadataContent extends AbstractBaseGetCapabilitiesFixture {
	...
	@Test(description = "NSG Web Map Tile Service (WMTS) 1.0.0, Requirements 4,7",
	...
	@Test(description = "NSG Web Map Tile Service (WMTS) 1.0.0, Requirements 4,7",
			dependsOnMethods = "wmtsCapabilitiesServiceIdentificationExists")
	public void wmtsCapabilitiesAccessConstraints() {
		// --- Test Method: 2 (The response uses <AccessContraints> to identify
		// classification levels for the service)
	...
	public void wmtsCapabilitiesAbstract() throws XPathExpressionException, XPathFactoryConfigurationException {
		// --- Test Method: 3 (The response in the Abstract element contains the following
		// information:
	...
	public void wmtsCapabilitiesNASkeywords() {
		// --- Test Method: 4.0 - (The response provides keywords based upon the NAS for
		// the following: Layer data
		// structure, Style data structure, Dimension data structure, TileMatrixSet data
		// structure, TileMatrix data
	...
	public void wmtsCapabilitiesNASkeywords_Layer() {
		// --- Test Method: 4.1 - (The response provides keywords based upon the NAS for
		// the following: Layer data
		// structure ...)
	...
	public void wmtsCapabilitiesNASkeywords_LayerStyle() {
		// --- Test Method: 4.2 - (The response provides keywords based upon the NAS for
		// the following: ..., Style data
		// structure, ...)
	...
	public void wmtsCapabilitiesNASkeywords_LayerDimension() {
		// --- Test Method: 4.3 - (The response provides keywords based upon the NAS for
	...
	public void wmtsCapabilitiesNASkeywords_TileMatrixSet() {
		// --- Test Method: 4.4 - (The response provides keywords based upon the NAS for
		// the following: ...
	...
	public void wmtsCapabilitiesNASkeywords_TileMatrix() {
		// --- Test Method: 4.5 - (The response provides keywords based upon the NAS for
		// the following: ... TileMatrix
		// data structure ...)
	...
	public void wmtsCapabilitiesNASkeywords_Theme() {
		// --- Test Method: 4.6 - (The response provides keywords based upon the NAS for
		// the following: ... Themes data
		// structure.)
		verifyNASkeywords(false, "Theme Data Structure", wmtsCapabilities, "//wmts:Theme/ows:Keywords");
	}

	@Test(description = "NSG Web Map Tile Service (WMTS) 1.0.0, Requirements 4,7",
			dependsOnMethods = "wmtsCapabilitiesContentsExists")
	public void wmtsCapabilitiesLayerStyles() throws XPathExpressionException, XPathFactoryConfigurationException {
		...
		// --- Test Method: 6 (The response provides a defined style for the default
		// style)
		XPath xPath = createXPath();
		...
		for (int i = 0; i < layerInfo.size(); i++) {
			...
			// --- will soft assess in order to go thru all layers //
			// assertXPath(exprPath, wmtsCapabilities,
			// NS_BINDINGS);
	...
	public void wmtsCapabilitiesLayerStyleLegends()
		...
		// --- Test Method: 7 (The response provides an associated legend in at least one
		// of the following formats: PNG,
		// GIF, JPEG)
		...
		// --- Test Method: 12 (The provided <MinScaleDenominator> value is less than or
		// equal to the
		// <MaxScaleDenominator>)
		XPath xPath = createXPath();
		if ((layerInfo == null) || (layerInfo.size() <= 0)) {
	...
	private void checkScaleDenominator(XPath xPath, SoftAssert sa, LayerInfo layer, String styleIdentifier, Node legend)
		...
		if (minScaleDenominatorIsSet && maxScaleDenominatorIsSet) {
			...
			sa.assertTrue(minScale <= maxScale, "The minScaleDenominator > maxScaleDenominator for <Layer>: "
					+ layer.getLayerName() + " and <Style>: " + styleIdentifier + " for a Legend");
		}
	}
	...
	public void wmtsCapabilitiesLayerDimension() throws XPathExpressionException, XPathFactoryConfigurationException {
		// --- Test Method: 9 (The response provides Dimension information, if applicable
		// to a layer)
		XPath xPath = createXPath();
		if ((layerInfo == null) || (layerInfo.size() <= 0)) {
			throw new SkipException("There are no Layers identified");
	...
	public void wmtsCapabilitiesLayerInfoFormat() throws XPathExpressionException, XPathFactoryConfigurationException {
		// --- Test Method: 10 (The response provides a valid output format for Layer data
		// structure infoFormat
	...
	public void wmtsCapabilitiesFeatureListURL() throws XPathExpressionException, XPathFactoryConfigurationException {
		// --- Test Method: 13 (The list of features is resolvable through the provided
		// FeatureListURLs)
	...
	public void wmtsCapabilitiesDataURL() throws XPathExpressionException, XPathFactoryConfigurationException {
		// --- Test Method: 14 (The data is resolvable through the provided URL for all
		// provided DatURLs)
